...
import { getHotelprofileAssignableItems, addHotelItem } from "../store/actions/vendor";


function ProfileAssignItemDrawer({ isOpen, onClose, profileprofileAssignableItems }) {
  ...
  // console.log(profileAssignableItems, "items")
  const filteredprofileAssignableItems = profileAssignableItems.filter(item =>
...
//       await dispatch(getHotelprofileAssignableItems(hotelId));
//     } catch (err) {
      ...
      <div className="h-[73vh] overflow-y-auto hide-scrollbar">
        <div className="mb-4">
          <div className="space-y-2">
            {filteredprofileAssignableItems
...
export default ProfileAssignItemDrawer;
